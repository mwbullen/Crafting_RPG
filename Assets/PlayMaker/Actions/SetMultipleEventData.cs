...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Sets Multiple Event Data before sending an event. Get the Event Data, along with sender information, using Get Event Info action.")]
	public class SetMultipleEventData : FsmStateAction
	{
